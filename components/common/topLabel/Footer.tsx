...
import { BackgroundImage, Container, Label, MainContainer } from "@/universal";
import { AbsoluteImg, AppDownload, JoinCommunity, Logo, SocialMedia } from "..";

export const Footer = () => (
  <BackgroundImage img={footerBgImg}>
